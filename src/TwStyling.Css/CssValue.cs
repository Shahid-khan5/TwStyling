...
internal enum CssUnitKind : byte { Number, Percent, Length, Angle, Time, Flex }
...
internal sealed class CssNumber : CssValue
{
...
internal sealed class CssColor : CssValue
{
...
internal sealed class CssIdent : CssValue
{
...
internal sealed class CssString : CssValue
{
...
internal sealed class CssDelim : CssValue
{
...
internal sealed class CssFunction : CssValue
{
    public readonly string Name;
...
/// </summary>
internal sealed class CssList : CssValue
{
...
internal sealed class CssCommaList : CssValue
{
    public readonly IReadOnlyList<CssValue> Items;
...
internal sealed class CssParenGroup : CssValue
{
